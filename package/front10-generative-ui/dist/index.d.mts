...
declare const useRegisterGenerativeComponent: <TInput = any, TOutput = any>(
  component: GenerativeUIComponent<TInput, TOutput>,
) => void;

declare const GenerativeUIRenderer: React.FC<GenerativeUIRendererProps>;
declare const useRenderGenerativeUI: () => (
...
export {
  ...
  type GenerativeUIRegistryType,
  GenerativeUIRenderer,
  type GenerativeUIRendererProps,
  type ToolState,
  type UseGenerativeUI,
  type UserAction,
  cn,
  useGenerativeUI,
